...
if (isset($_GET['token'])) {
    ...
    $sql = "SELECT * FROM register_student WHERE activation_token='$token'";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql_update = "UPDATE register_student SET is_activated=1, activation_token=NULL WHERE activation_token='$token'";
